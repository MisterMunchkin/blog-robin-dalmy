...
This [visualstudio documentation](https://code.visualstudio.com/api/working-with-extensions/publishing-extension) does a great write-up on a step-by-step guide on how to publish extensions and all the things you would want to do to your extension like versioning, depecrating, and packaging.

## Closing Thoughts

This blog really just hits the tip of the iceberg with what you can do with vscode extensions, but hopefully, you found it informative and helpful. 

If you really liked it, consider [buying me a ☕️](https://www.paypal.com/donate/?hosted_button_id=B9HDECYJ4CEF8). Thanks! 